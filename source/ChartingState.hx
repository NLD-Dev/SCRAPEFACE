...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		check_mine = new FlxUICheckBox(10, 30, null, null, "Mine Note", 100);
		check_mine.name = 'check_mine';
		check_mine.checked = false;

		var applyLength:FlxButton = new FlxButton(10, 120, 'Apply Data');

		tab_group_note.add(check_mine);
	...
	function updateGrid():Void
	{
		...
		for (i in sectionInfo)
		{
			...
			notee.visible = false;
			var note:Note = new Note(daStrumTime, daNoteInfo % 4, notee, false, dawhat);
	...
	private function addNote(?n:Note):Void
	{
		...
		var fire = false;
		if (n != null)
			_song.notes[curSection].sectionNotes.push([n.strumTime, n.noteData, n.sustainLength, n.fire]);
		else
			_song.notes[curSection].sectionNotes.push([noteStrum, noteData, noteSus, fire]);
